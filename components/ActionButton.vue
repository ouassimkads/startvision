...
<template>
  <ClientOnly>
    ...
    <div v-else class="flex gap-1 font-[Inter]">
      ...
      <div v-if=" auth.role === 'user'"  class="dropdown dropdown-bottom dropdown-end dropdown-hover">
        ...
        <div v-if=" auth.role === 'company'"  class="dropdown dropdown-bottom dropdown-end dropdown-hover">
        <UButton
              :avatar="{
                src: 'https://github.com/nuxt.png'
              }"
        ...
        <div v-if=" auth.role === 'admin'"  class="dropdown dropdown-bottom dropdown-end dropdown-hover">
        <UButton
              :avatar="{
                src: 'https://github.com/nuxt.png'
              }"
