        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    ...
                    <p>
                        <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-blue-400 hover:before:bg-blue-500  dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="mailto:example@site.so">
                        startvision@gmail.com
                        </a>
                    </p>
                    </div>
                </div>
